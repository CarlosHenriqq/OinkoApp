        ...
        <View style={{ backgroundColor: '#E0E8F9', flex: 1 }}>
            <View style={{
                ...
                <View style={styles.container}>
                    ...
                    <Button title='Finalizar' onPress={()=> router.replace('/auth/login')}/>
                    </View>
                </View>
            
                <TouchableOpacity  onPress={()=> router.push('/auth/register')}>
                    <Text style={{textAlign:'center', fontFamily:'manrope', textDecorationLine:'underline', fontSize:16, fontWeight:'600', color:'#4a4a4a'}}>Voltar para a tela anterior</Text>
                </TouchableOpacity>
